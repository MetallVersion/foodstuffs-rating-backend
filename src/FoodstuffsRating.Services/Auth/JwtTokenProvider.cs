...
namespace FoodstuffsRating.Services.Auth
{
    ...
    public class JwtTokenProvider : IJwtTokenProvider
    {
        ...
        public string CreateToken(Guid userId, string userEmail)
        {
            ...
            var jwt = jwtHandler.CreateJwtSecurityToken(issuer: this._jwtOptions.Issuer,
            ...
            string jwtToken = jwtHandler.WriteToken(jwt);
        ...
        public ClaimsPrincipal ValidateToken(string jwtToken, bool validateLifetime = true)
        {
            ...
            var jwtHandler = new JwtSecurityTokenHandler();
            var principal = jwtHandler.ValidateToken(jwtToken, tokenValidationParameters,
